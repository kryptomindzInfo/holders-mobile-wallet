...
Before you can proceed with building and testing the Lattice Labs Wallet app, you must install and configure the following products on your development machine:
...
# Go to the Lattice Labs Wallet directory:
cd bc-wallet-mobile
```
...
Next, install the npm modules needed to build and test Lattice Labs Wallet from the root of the repository:

```sh
# Install Lattice Labs Wallet project dependencies (package.json) from the root of the cloned repository
yarn install
```
