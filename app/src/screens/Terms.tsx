    ...
    <SafeAreaView edges={['left', 'right', 'bottom']}>
      <ScrollView style={[style.container]}>
        ...
        <Text style={[style.bodyText, { marginTop: 20 }]}>
          The Lattice Labs Wallet App (the “Licensed Application”) allows you (“You” or “you”) to store your verifiable
          ...
          and/or use the Lattice Labs Wallet App. This EULA is a legal agreement between you, as the end user of the Licensed
          Application (“You” or “you”), and Her Majesty the Queen in Right of the Province of Lattice Labs (the
        ...
        <View style={style.paragraph}>
          ...
          <Text style={[style.bodyText]}>
            ...
            the Licensed Application, should be directed to: Product Owner, Lattice Labs Wallet, ditrust@gov.bc.ca, 4000 Seymour
        ...
        <View style={style.paragraph}>
          ...
          <Text style={[style.bodyText]}>
            ...
            <Text style={[style.link]} onPress={useCallback(() => openLink(digitalWalletPrivacyUrl), [])}>
              Lattice Labs Wallet App Privacy Policy
            </Text>{' '}
        ...
        <View style={style.paragraph}>
          ...
          <Text style={[style.bodyText]}>
            ...
            and construed in accordance with the laws of the province of Lattice Labs and the applicable laws of
            Canada. By using the Licensed Application, you consent to the exclusive jurisdiction and venue of the courts
            of the province of Lattice Labs, sitting in Victoria, for the hearing of any dispute arising from or
