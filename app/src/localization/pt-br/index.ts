...
const translation = {
  ...
  "CameraDisclosure": {
    ...
    "ToContinueUsing": "To continue using the Lattice Labs Wallet scan feature, please allow camera permissions. (PT-BR)",
    "Allow": "Allow (PT-BR)",
  ...
  "Biometry": {
    ...
    "EnabledText1Bold": "you will need to use biometrics to open your Lattice Labs Wallet. (PT-BR)",
    "EnabledText2": "This means all fingerprint and facial data added on this phone can be used to access your Lattice Labs Wallet. (PT-BR)",
    "EnabledText3": "Anyone who can access your phone with biometrics can access your Lattice Labs Wallet. (PT-BR)",
  ...
  "Onboarding": {
    ...
    "WelcomeParagraph1": "Lattice Labs Wallet lets you receive, store and use digital credentials. (PT-BR)",
    "WelcomeParagraph2": "It is highly secure, and helps protect your privacy online. (PT-BR)",
    "WelcomeParagraph3": "Lattice Labs Wallet is currently in its early stages and the technology is being explored. Most people will not have a use for Lattice Labs Wallet yet, because very few digital credentials are available. (PT-BR)",
    "StoredSecurelyTitle": "Digital credentials, stored securely (PT-BR)",
    "StoredSecurelyBody": "Lattice Labs Wallet holds digital credentials—the digital versions of things like licenses, identities and permits.\n\nThey are stored securely, only on this device. (PT-BR)",
    ...
    "PrivacyParagraph": "You approve every use of information from your Lattice Labs Wallet. You also only share what is needed for a situation.\n\nThe Government of Lattice Labs is not told when you use your digital credentials. (PT-BR)",
    "GetStarted": "Get Started (PT-BR)",
    "SkipA11y": "Skip introduction to Lattice Labs Wallet (PT-BR)",
  },
  "Screens": {
    "Onboarding": "Lattice Labs Wallet (PT-BR)",
    "Settings": "Menu (PT-BR)",
  },
  ...
  "NetInfo": {
    ...
    "NoInternetConnectionMessage": "You're unable to access services using Lattice Labs Wallet or receive credentials until you're back online.\n\nPlease check your internet connection. (PT-BR)",
  },
  "Tour": {
    "GuideTitle": "Welcome to Lattice Labs Wallet (PT-BR)",
    "WouldYouLike": "Would you like some guidance on how to use Lattice Labs Wallet? (PT-BR)",
  ...
  "Settings": {
    ...
    "HelpUsingBCWallet": "Help using Lattice Labs Wallet (PT-BR)",
  ...
  "Tips": {
    ...
    "Tip1": "For extra security, Lattice Labs Wallet locks the app after 5 minutes of inactivity (PT-BR)",
