...
const translation = {
  ...
  "CameraDisclosure": {
    ...
    "ToContinueUsing": "To continue using the Lattice Labs Wallet scan feature, please allow camera permissions.",
    "Allow": "Allow",
  ...
  "Biometry": {
    ...
    "EnabledText1Bold": "you will need to use biometrics to open your Lattice Labs Wallet.",
    "EnabledText2": "This means all fingerprint and facial data added on this phone can be used to access your Lattice Labs Wallet.",
    "EnabledText3": "Anyone who can access your phone with biometrics can access your Lattice Labs Wallet.",
  ...
  "Onboarding": {
    "Welcome": "Welcome",
    "WelcomeParagraph1": "Lattice Labs Wallet lets you receive, store and use digital credentials.",
    "WelcomeParagraph2": "It is highly secure, and helps protect your privacy online.",
    "WelcomeParagraph3": "Lattice Labs Wallet is currently in its early stages and the technology is being explored. Most people will not have a use for Lattice Labs Wallet yet, because very few digital credentials are available.",
    ...
    "PrivacyParagraph": "You approve every use of information from your Lattice Labs Wallet. You also only share what is needed for a situation.\n\nThe Government of Lattice Labs is not told when you use your digital credentials.",
    "GetStarted": "Get Started",
    "SkipA11y": "Skip introduction to Lattice Labs Wallet",
  },
  "Screens": {
    "Onboarding": "Lattice Labs Wallet",
    "Settings": "Menu",
  },
  ...
  "Tour": {
    "GuideTitle": "Welcome to Lattice Labs Wallet",
    "WouldYouLike": "Would you like some guidance on how to use Lattice Labs Wallet?",
  ...
  "Settings": {
    ...
    // "HelpUsingBCWallet": "Help using Lattice Labs Wallet",
  ...
  "Tips": {
    ...
    "Tip1": "For extra security, Lattice Labs Wallet locks the app after 5 minutes of inactivity",
